...
--------------------------------------------------------
  ...
  --  CREATE SEQUENCE  "MEDICAL_SYSTEM"."USERS_ID_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 421 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Table CACHE
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "MEDICAL_SYSTEM"."PATIENTS" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	...
	"PHONE_NUMBER" VARCHAR2(15 BYTE), 
	"DATE_OF_BIRTH" DATE DEFAULT TO_DATE('2000-01-01', 'YYYY-MM-DD')
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
SET DEFINE OFF;
Insert into MEDICAL_SYSTEM.DOCTORS (NAME,LAST_NAME,SPECIALIZATION,PHONE_NUMBER) values ('Dawid','Wójcik','Onkologia dziecięca','575992620');
Insert into MEDICAL_SYSTEM.DOCTORS (NAME,LAST_NAME,SPECIALIZATION,PHONE_NUMBER) values ('Robert','Świder','Dermatologia','920378612');
Insert into MEDICAL_SYSTEM.DOCTORS (NAME,LAST_NAME,SPECIALIZATION,PHONE_NUMBER) values ('Jarosław','Kuczyński','Alergologia','610975653');
Insert into MEDICAL_SYSTEM.DOCTORS (NAME,LAST_NAME,SPECIALIZATION,PHONE_NUMBER) values ('Łukasz','Zuchniak','Psychologia','913816554');
Insert into MEDICAL_SYSTEM.DOCTORS (NAME,LAST_NAME,SPECIALIZATION,PHONE_NUMBER) values ('Krystian','Dybiec','Urologia','224917951');
Insert into MEDICAL_SYSTEM.DOCTORS (NAME,LAST_NAME,SPECIALIZATION,PHONE_NUMBER) values ('Paweł','Zieliński','Ginekologia','321987654');
Insert into MEDICAL_SYSTEM.DOCTORS (NAME,LAST_NAME,SPECIALIZATION,PHONE_NUMBER) values ('Maria','Dąbrowska','Fizjoterapia','789123456');
Insert into MEDICAL_SYSTEM.DOCTORS (NAME,LAST_NAME,SPECIALIZATION,PHONE_NUMBER) values ('Piotr','Wiśniewski','Dermatologia','456123789');
Insert into MEDICAL_SYSTEM.DOCTORS (NAME,LAST_NAME,SPECIALIZATION,PHONE_NUMBER) values ('Anna','Nowak','Neurologia','987654321');
Insert into MEDICAL_SYSTEM.DOCTORS (NAME,LAST_NAME,SPECIALIZATION,PHONE_NUMBER) values ('Jan','Kowalski','Kardiologia','123456789');
REM INSERTING into MEDICAL_SYSTEM.DOCUMENTATIONS
SET DEFINE OFF;
Insert into MEDICAL_SYSTEM.DOCUMENTATIONS (VISIT_ID,DOCUMENTATION_DATE,DIAGNOSIS,TREATMENT_METHOD) values ('9',to_timestamp('24/06/02 14:30:53,650616000','RR/MM/DD HH24:MI:SSXFF'),'Osłabione mięśnie.','Ćwiczenia na wzmocnienie pleców oraz kręgosłupa');
Insert into MEDICAL_SYSTEM.DOCUMENTATIONS (VISIT_ID,DOCUMENTATION_DATE,DIAGNOSIS,TREATMENT_METHOD) values ('10',to_timestamp('24/06/02 14:31:44,975321000','RR/MM/DD HH24:MI:SSXFF'),'Fizjoterapia przebiega pomyślnie.','Brak');
Insert into MEDICAL_SYSTEM.DOCUMENTATIONS (VISIT_ID,DOCUMENTATION_DATE,DIAGNOSIS,TREATMENT_METHOD) values ('3',to_timestamp('24/06/02 14:01:33,827173000','RR/MM/DD HH24:MI:SSXFF'),'Uczulenie na pyłki, brzozę oraz koty.','W miarę możliwości ograniczenie kontaktu z kotami oraz innymi alergenami.');
Insert into MEDICAL_SYSTEM.DOCUMENTATIONS (VISIT_ID,DOCUMENTATION_DATE,DIAGNOSIS,TREATMENT_METHOD) values ('1',to_timestamp('24/06/02 13:54:30,451643000','RR/MM/DD HH24:MI:SSXFF'),'Brak witaminy A oraz B','Dawkowanie leku codziennie z rana. Spożywanie naturalnych źródeł witaminy A oraz B.');
Insert into MEDICAL_SYSTEM.DOCUMENTATIONS (VISIT_ID,DOCUMENTATION_DATE,DIAGNOSIS,TREATMENT_METHOD) values ('2',to_timestamp('24/06/02 13:59:14,223347000','RR/MM/DD HH24:MI:SSXFF'),'Niedobór witamin grupy B.','Mycie włosów specjalnym szamponem + dawkowanie leku rano i wieczór.');
Insert into MEDICAL_SYSTEM.DOCUMENTATIONS (VISIT_ID,DOCUMENTATION_DATE,DIAGNOSIS,TREATMENT_METHOD) values ('4',to_timestamp('24/06/02 14:04:43,705107000','RR/MM/DD HH24:MI:SSXFF'),'Początkowy stan depresji.','Dawkowanie leków, skupienie się na rzeczach sprawiających przyjemność.');
Insert into MEDICAL_SYSTEM.DOCUMENTATIONS (VISIT_ID,DOCUMENTATION_DATE,DIAGNOSIS,TREATMENT_METHOD) values ('5',to_timestamp('24/06/02 14:11:48,958807000','RR/MM/DD HH24:MI:SSXFF'),'Zapalenie układu moczowego','Dawkowanie leku, ograniczenie spożywania słodkich napojów.');
Insert into MEDICAL_SYSTEM.DOCUMENTATIONS (VISIT_ID,DOCUMENTATION_DATE,DIAGNOSIS,TREATMENT_METHOD) values ('6',to_timestamp('24/06/02 14:26:44,799760000','RR/MM/DD HH24:MI:SSXFF'),'Brak','Brak');
Insert into MEDICAL_SYSTEM.DOCUMENTATIONS (VISIT_ID,DOCUMENTATION_DATE,DIAGNOSIS,TREATMENT_METHOD) values ('7',to_timestamp('24/06/02 14:27:11,547535000','RR/MM/DD HH24:MI:SSXFF'),'Brak','Brak');
Insert into MEDICAL_SYSTEM.DOCUMENTATIONS (VISIT_ID,DOCUMENTATION_DATE,DIAGNOSIS,TREATMENT_METHOD) values ('8',to_timestamp('24/06/02 14:28:54,692580000','RR/MM/DD HH24:MI:SSXFF'),'Płaskostopie','Specjalny but do chodzenia, rutynowe kontrole u fizjoterapeuty.');
...
-- SET DEFINE OFF;
Insert into MEDICAL_SYSTEM.PATIENTS (NAME,LAST_NAME,GENDER,ADDRESS,PHONE_NUMBER,DATE_OF_BIRTH) values ('Józef','Kijowski','Mężczyzna','ul. Kwiatowa 1, Warszawa','123456789',to_date('84/05/06','RR/MM/DD'));
Insert into MEDICAL_SYSTEM.PATIENTS (NAME,LAST_NAME,GENDER,ADDRESS,PHONE_NUMBER,DATE_OF_BIRTH) values ('Anna','Nowakowska','Kobieta','ul. Leśna 5, Kraków','987654321',to_date('99/04/19','RR/MM/DD'));
Insert into MEDICAL_SYSTEM.PATIENTS (NAME,LAST_NAME,GENDER,ADDRESS,PHONE_NUMBER,DATE_OF_BIRTH) values ('Paweł','Wiśniewski','Mężczyzna','ul. Słoneczna 10, Wrocław','456123789',to_date('86/06/12','RR/MM/DD'));
Insert into MEDICAL_SYSTEM.PATIENTS (NAME,LAST_NAME,GENDER,ADDRESS,PHONE_NUMBER,DATE_OF_BIRTH) values ('Agnieszka','Dąbrowska','Kobieta','ul. Polna 7, Gdańsk','789456123',to_date('94/02/20','RR/MM/DD'));
Insert into MEDICAL_SYSTEM.PATIENTS (NAME,LAST_NAME,GENDER,ADDRESS,PHONE_NUMBER,DATE_OF_BIRTH) values ('Katarzyna','Lewandowska','Kobieta','ul. Zielona 3, Poznań','654987321',to_date('01/02/12','RR/MM/DD'));
Insert into MEDICAL_SYSTEM.PATIENTS (NAME,LAST_NAME,GENDER,ADDRESS,PHONE_NUMBER,DATE_OF_BIRTH) values ('Andrzej','Wójcik','Mężczyzna','ul. Górska 12, Rzeszów','321654987',to_date('89/07/21','RR/MM/DD'));
Insert into MEDICAL_SYSTEM.PATIENTS (NAME,LAST_NAME,GENDER,ADDRESS,PHONE_NUMBER,DATE_OF_BIRTH) values ('Maria','Kowalczyk','Kobieta','ul. Morska 8, Szczecin','987321654',to_date('00/11/21','RR/MM/DD'));
Insert into MEDICAL_SYSTEM.PATIENTS (NAME,LAST_NAME,GENDER,ADDRESS,PHONE_NUMBER,DATE_OF_BIRTH) values ('Tomasz','Kamiński','Mężczyzna','ul. Parkowa 15, Lublin','741852963',to_date('90/02/13','RR/MM/DD'));
Insert into MEDICAL_SYSTEM.PATIENTS (NAME,LAST_NAME,GENDER,ADDRESS,PHONE_NUMBER,DATE_OF_BIRTH) values ('Barbara','Zielińska','Kobieta','ul. Ogrodowa 4, Katowice','369258147',to_date('87/09/23','RR/MM/DD'));
REM INSERTING into MEDICAL_SYSTEM.PRESCRIPTION_MEDICINES
SET DEFINE OFF;
Insert into MEDICAL_SYSTEM.PRESCRIPTION_MEDICINES (PRESCRIPTION_ID,MEDICINE_ID,DOSAGE,PAYMENT) values ('1','3','1x rano na czczo','100');
Insert into MEDICAL_SYSTEM.PRESCRIPTION_MEDICINES (PRESCRIPTION_ID,MEDICINE_ID,DOSAGE,PAYMENT) values ('1','9','w środku dnia, np. po obiedzie 1x','100');
Insert into MEDICAL_SYSTEM.PRESCRIPTION_MEDICINES (PRESCRIPTION_ID,MEDICINE_ID,DOSAGE,PAYMENT) values ('2','12','1x rano + wieczór','100');
REM INSERTING into MEDICAL_SYSTEM.PRESCRIPTIONS
SET DEFINE OFF;
Insert into MEDICAL_SYSTEM.PRESCRIPTIONS (VISIT_ID,EXPIRATION_DATE,CODE) values ('1',to_timestamp('24/06/16 00:00:00,000000000','RR/MM/DD HH24:MI:SSXFF'),'7809');
Insert into MEDICAL_SYSTEM.PRESCRIPTIONS (VISIT_ID,EXPIRATION_DATE,CODE) values ('2',to_timestamp('24/06/30 00:00:00,000000000','RR/MM/DD HH24:MI:SSXFF'),'3916');
REM INSERTING into MEDICAL_SYSTEM.SESSIONS
SET DEFINE OFF;
-- Insert into MEDICAL_SYSTEM.SESSIONS (ID,USER_ID,IP_ADDRESS,LAST_ACTIVITY) values ('XMk4rjdzMRYL0Yu1bPhDPS10FXKt66qc3Ij1HnAd','402','127.0.0.1','1717341364');
REM INSERTING into MEDICAL_SYSTEM.USERS
SET DEFINE OFF;
-- Insert into MEDICAL_SYSTEM.USERS (NAME,LAST_NAME,IS_DOCTOR,TABLE_ID) values ('402','Jarosław','Kuczyński','1','3');
REM INSERTING into MEDICAL_SYSTEM.VISITS
SET DEFINE OFF;
Insert into MEDICAL_SYSTEM.VISITS (PATIENT_ID,DOCTOR_ID,REASON,START_DATE,END_DATE) values ('2','7','Ból kręgosłupa',to_timestamp('24/06/02 13:29:56,000000000','RR/MM/DD HH24:MI:SSXFF'),to_timestamp('24/06/02 14:32:00,000000000','RR/MM/DD HH24:MI:SSXFF'));
Insert into MEDICAL_SYSTEM.VISITS (PATIENT_ID,DOCTOR_ID,REASON,START_DATE,END_DATE) values ('1','7','Rutynowa kontrola fizjoterapii',to_timestamp('24/06/02 16:31:03,000000000','RR/MM/DD HH24:MI:SSXFF'),to_timestamp('24/06/02 17:16:00,000000000','RR/MM/DD HH24:MI:SSXFF'));
Insert into MEDICAL_SYSTEM.VISITS (PATIENT_ID,DOCTOR_ID,REASON,START_DATE,END_DATE) values ('7','3','Duszności, katar, spuchnięte oczy.',to_timestamp('24/06/02 10:59:47,000000000','RR/MM/DD HH24:MI:SSXFF'),to_timestamp('24/06/02 12:05:00,000000000','RR/MM/DD HH24:MI:SSXFF'));
Insert into MEDICAL_SYSTEM.VISITS (PATIENT_ID,DOCTOR_ID,REASON,START_DATE,END_DATE) values ('9','2','Zaczerwienienia na skórze',to_timestamp('24/06/02 13:52:41,000000000','RR/MM/DD HH24:MI:SSXFF'),to_timestamp('24/06/02 14:27:00,000000000','RR/MM/DD HH24:MI:SSXFF'));
Insert into MEDICAL_SYSTEM.VISITS (PATIENT_ID,DOCTOR_ID,REASON,START_DATE,END_DATE) values ('8','2','Problemy na skórze głowy',to_timestamp('24/06/02 08:57:14,000000000','RR/MM/DD HH24:MI:SSXFF'),to_timestamp('24/06/02 09:37:00,000000000','RR/MM/DD HH24:MI:SSXFF'));
Insert into MEDICAL_SYSTEM.VISITS (PATIENT_ID,DOCTOR_ID,REASON,START_DATE,END_DATE) values ('6','4','Podejrzenia depresji',to_timestamp('24/06/02 14:02:51,000000000','RR/MM/DD HH24:MI:SSXFF'),to_timestamp('24/06/02 16:07:00,000000000','RR/MM/DD HH24:MI:SSXFF'));
Insert into MEDICAL_SYSTEM.VISITS (PATIENT_ID,DOCTOR_ID,REASON,START_DATE,END_DATE) values ('5','5','Problemy z oddawaniem moczu',to_timestamp('24/06/02 16:10:41,000000000','RR/MM/DD HH24:MI:SSXFF'),to_timestamp('24/06/02 16:44:00,000000000','RR/MM/DD HH24:MI:SSXFF'));
Insert into MEDICAL_SYSTEM.VISITS (PATIENT_ID,DOCTOR_ID,REASON,START_DATE,END_DATE) values ('4','6','Rutynowa kontrola ciąży',to_timestamp('24/06/02 14:15:04,000000000','RR/MM/DD HH24:MI:SSXFF'),to_timestamp('24/06/02 15:26:00,000000000','RR/MM/DD HH24:MI:SSXFF'));
Insert into MEDICAL_SYSTEM.VISITS (PATIENT_ID,DOCTOR_ID,REASON,START_DATE,END_DATE) values ('2','6','Rutynowa kontrola ciąży',to_timestamp('24/06/02 16:26:54,000000000','RR/MM/DD HH24:MI:SSXFF'),to_timestamp('24/06/02 17:27:00,000000000','RR/MM/DD HH24:MI:SSXFF'));
Insert into MEDICAL_SYSTEM.VISITS (PATIENT_ID,DOCTOR_ID,REASON,START_DATE,END_DATE) values ('3','7','Ból przy chodzeniu w kostce',to_timestamp('24/06/02 10:27:41,000000000','RR/MM/DD HH24:MI:SSXFF'),to_timestamp('24/06/02 11:08:00,000000000','RR/MM/DD HH24:MI:SSXFF'));
--------------------------------------------------------
...
AS
BEGIN
    INSERT INTO PATIENTS (NAME, LAST_NAME, GENDER, ADDRESS, PHONE_NUMBER, DATE_OF_BIRTH)
    VALUES (P_NAME, P_LAST_NAME, P_GENDER, P_ADDRESS, P_PHONE_NUMBER, P_DATE_OF_BIRTH);
    COMMIT;
EXCEPTION
    WHEN OTHERS THEN
        ROLLBACK;
...
/
--------------------------------------------------------
--  DDL for Function CALCULATE_AVERAGE_VISITS_BY_AGE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "MEDICAL_SYSTEM"."CALCULATE_AVERAGE_VISITS_BY_AGE" 
...
/
--------------------------------------------------------
--  DDL for Function CALCULATE_GENDER_PERCENTAGE
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "MEDICAL_SYSTEM"."CALCULATE_GENDER_PERCENTAGE" (age_range_start NUMBER, age_range_end NUMBER)
RETURN SYS_REFCURSOR IS
  gender_cursor SYS_REFCURSOR;
BEGIN
  OPEN gender_cursor FOR
    SELECT gender, (COUNT(gender) * 100 / (SELECT COUNT(*) FROM PATIENTS WHERE (EXTRACT(YEAR FROM SYSDATE) - EXTRACT(YEAR FROM date_of_birth)) BETWEEN age_range_start AND age_range_end)) AS percentage
    FROM PATIENTS
    WHERE (EXTRACT(YEAR FROM SYSDATE) - EXTRACT(YEAR FROM date_of_birth)) BETWEEN age_range_start AND age_range_end
    GROUP BY gender;
  RETURN gender_cursor;
END calculate_gender_percentage;
...
/
--------------------------------------------------------
--  DDL for Function GET_PATIENT_VISITS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "MEDICAL_SYSTEM"."GET_PATIENT_VISITS" (
    p_patient_id IN NUMBER
) RETURN SYS_REFCURSOR
AS
    visits_cursor SYS_REFCURSOR;
BEGIN
    OPEN visits_cursor FOR
        SELECT v.ID AS VISIT_ID,
               ...
               d.LAST_NAME AS DOCTOR_LAST_NAME,
               d.SPECIALIZATION AS DOCTOR_SPECIALIZATION,
               doc.DIAGNOSIS AS VISIT_DIAGNOSIS,
               doc.TREATMENT_METHOD AS VISIT_TREATMENT_METHOD
        FROM VISITS v
        JOIN DOCTORS d ON v.DOCTOR_ID = d.ID
        LEFT JOIN DOCUMENTATIONS doc ON v.ID = doc.VISIT_ID
        WHERE v.PATIENT_ID = p_patient_id
        ORDER BY v.START_DATE DESC;
