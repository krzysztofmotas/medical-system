...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "MEDICAL_SYSTEM"."USERS_ID_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 121 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Table CACHE
--------------------------------------------------------
...
Insert into MEDICAL_SYSTEM.DOCUMENTATIONS (ID,VISIT_ID,DOCUMENTATION_DATE,DIAGNOSIS,TREATMENT_METHOD) values ('61','61',to_timestamp('24/05/31 23:21:02,564230000','RR/MM/DD HH24:MI:SSXFF'),'test','test 2');
...
SET DEFINE OFF;
Insert into MEDICAL_SYSTEM.PRESCRIPTION_MEDICINES (ID,PRESCRIPTION_ID,MEDICINE_ID,DOSAGE,PAYMENT) values ('21','21','21','2x2','100');
Insert into MEDICAL_SYSTEM.PRESCRIPTION_MEDICINES (ID,PRESCRIPTION_ID,MEDICINE_ID,DOSAGE,PAYMENT) values ('22','21','10','2x2','100');
REM INSERTING into MEDICAL_SYSTEM.PRESCRIPTIONS
SET DEFINE OFF;
Insert into MEDICAL_SYSTEM.PRESCRIPTIONS (ID,VISIT_ID,EXPIRATION_DATE,CODE) values ('21','61',to_timestamp('24/05/31 23:21:02,000000000','RR/MM/DD HH24:MI:SSXFF'),'6697');
REM INSERTING into MEDICAL_SYSTEM.ROOMS
SET DEFINE OFF;
REM INSERTING into MEDICAL_SYSTEM.SESSIONS
SET DEFINE OFF;
Insert into MEDICAL_SYSTEM.SESSIONS (ID,USER_ID,IP_ADDRESS,LAST_ACTIVITY) values ('ad8QBDIoUbz9dslZPhC6VvWdPscaWPHolupxGPjW','101','127.0.0.1','1717193807');
REM INSERTING into MEDICAL_SYSTEM.USERS
SET DEFINE OFF;
Insert into MEDICAL_SYSTEM.USERS (ID,NAME,LAST_NAME,IS_DOCTOR,TABLE_ID) values ('101','Dawid','Wójcik','1','1');
...
Insert into MEDICAL_SYSTEM.VISITS (ID,PATIENT_ID,DOCTOR_ID,REASON,START_DATE,END_DATE) values ('61','1','1','test',to_timestamp('24/05/31 23:20:37,000000000','RR/MM/DD HH24:MI:SSXFF'),to_timestamp('24/05/31 23:21:02,000000000','RR/MM/DD HH24:MI:SSXFF'));
--------------------------------------------------------
