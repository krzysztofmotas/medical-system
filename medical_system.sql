--------------------------------------------------------
--  File created - piątek-maja-31-2024   
--------------------------------------------------------
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into MEDICAL_SYSTEM.SESSIONS (ID,USER_ID,IP_ADDRESS,LAST_ACTIVITY) values ('tvoesdbNjG0mdldU4jMBXGku9cWtAdwNSaQcQSg9','85','127.0.0.1','1717188305');
