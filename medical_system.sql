...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "MEDICAL_SYSTEM"."USERS_ID_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Table CACHE
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into MEDICAL_SYSTEM.SESSIONS (ID,USER_ID,IP_ADDRESS,LAST_ACTIVITY) values ('nhrme673AGomICvnBP50zkgjVA2Ry7LBmFT7H28b',null,'127.0.0.1','1716665359');
Insert into MEDICAL_SYSTEM.SESSIONS (ID,USER_ID,IP_ADDRESS,LAST_ACTIVITY) values ('zVTgMTMaYFWNWriQbTe8RMVb4aRcqlUa4v9wWT7f','4','127.0.0.1','1716670118');
REM INSERTING into MEDICAL_SYSTEM.USERS
SET DEFINE OFF;
Insert into MEDICAL_SYSTEM.USERS (ID,NAME,LAST_NAME,IS_DOCTOR,TABLE_ID) values ('2','Józef','Kijowski','0','1');
Insert into MEDICAL_SYSTEM.USERS (ID,NAME,LAST_NAME,IS_DOCTOR,TABLE_ID) values ('4','Barbara','Zieliñska','0','9');
Insert into MEDICAL_SYSTEM.USERS (ID,NAME,LAST_NAME,IS_DOCTOR,TABLE_ID) values ('1','Dawid','Wójcik','1','1');
Insert into MEDICAL_SYSTEM.USERS (ID,NAME,LAST_NAME,IS_DOCTOR,TABLE_ID) values ('3','Dawid','Wójcik','1','1');
