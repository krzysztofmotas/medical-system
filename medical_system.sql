...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "MEDICAL_SYSTEM"."USERS_ID_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 161 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Table CACHE
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into MEDICAL_SYSTEM.PRESCRIPTIONS (ID,VISIT_ID,EXPIRATION_DATE,CODE) values ('66','81',to_timestamp('25/06/01 10:41:11,000000000','RR/MM/DD HH24:MI:SSXFF'),'3534');
...
SET DEFINE OFF;
Insert into MEDICAL_SYSTEM.SESSIONS (ID,USER_ID,IP_ADDRESS,LAST_ACTIVITY) values ('KaqvUtLhnbsrGhwiRwd1q4bQ1AvED1tfeje4ADrp',null,'127.0.0.1','1717226581');
Insert into MEDICAL_SYSTEM.SESSIONS (ID,USER_ID,IP_ADDRESS,LAST_ACTIVITY) values ('mG5TscuggBsctEX6TrhiPAE0aBL2X76hLlLHEFE6','145','127.0.0.1','1717234141');
REM INSERTING into MEDICAL_SYSTEM.USERS
SET DEFINE OFF;
Insert into MEDICAL_SYSTEM.USERS (ID,NAME,LAST_NAME,IS_DOCTOR,TABLE_ID) values ('145','Patryk','Jarosiewicz','0','22');
REM INSERTING into MEDICAL_SYSTEM.VISITS
SET DEFINE OFF;
Insert into MEDICAL_SYSTEM.VISITS (ID,PATIENT_ID,DOCTOR_ID,REASON,START_DATE,END_DATE) values ('81','8','1','złamana noga',to_timestamp('24/06/01 10:40:31,000000000','RR/MM/DD HH24:MI:SSXFF'),to_timestamp('24/06/01 10:41:10,000000000','RR/MM/DD HH24:MI:SSXFF'));
